...
export class CreateAttributeGroupDto extends createZodDto(
...
export class UpdateAttributeGroupDto extends createZodDto(
...
export class CreateAttributeOptionDto extends createZodDto(
...
export class UpdateAttributeOptionDto extends createZodDto(
