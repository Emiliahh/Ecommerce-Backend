...
const getCategoryFilterSchema = z
  .object({
    q: z.string().optional(),
    ...
    rootOnly: booleanString
      .optional()
      .default(false)
      .describe('only return root categories (those without a parent)'),
    includeAttributes: booleanString
      .optional()
      .default(false)
      .describe('include attribute groups with attributes and options'),
    maxDepth: z.coerce
      .number()
      .optional()
      .default(0)
      .describe('maximum depth of categories to return'),
  })
  .extend(paginateSchema.shape);

export class GetCategoryFilterDto extends createZodDto(
...
export class GetCategoryFilterResponseDto extends createZodDto(
  getCategoryFilterResponseSchema,
) {}
